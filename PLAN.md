...
- [ ] Watch it in the editor with a window (Richard: `open unreal/Hearth/Hearth.uproject`, Play) and confirm characters walk between places on the NavMesh
...
| 2026-09-04 (later) | Xcode 26.6 + UE 5.8.2 installed. Module compiles (1 fix). Metal Toolchain installed. Valley map built by Python commandlet. Headless brain→Unreal run passes all checks. Unreal ini gotcha: `//` in a value is a comment; quote URLs. |
